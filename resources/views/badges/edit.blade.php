                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 clearfix">
                            {!! Form::open(['method' => 'put', 'route' => ['badges.update', 'badge' => $badge], 'id' => 'content_form']) !!}

                            <div class="form-group @if($errors->has('name')) has-error @endif">
                                {{ Form::label('name', 'Badge name', ['class' => 'control-label']) }}
                                {{ Form::text('name', $badge->name, ['class' => 'form-control', 'id' => 'name']) }}
                            </div>
                            ...
                            <div class="form-group @if($errors->has('constraints')) has-error @endif">
                                ...
                                {{ Form::textarea('constraints', $badge->constraints, ['class' => 'form-control', 'id' => 'constraints']) }}
                            </div>

                            <div class="form-group @if($errors->has('commands')) has-error @endif">
                                {{ Form::label('commands', 'Commands', ['class' => 'control-label']) }}
                                {{ Form::textarea('commands', $badge->commands, ['class' => 'form-control', 'id' => 'commands']) }}
